...
class Paypal(BasePaymentProcessor):
    ...
    CHECKOUT_BUTTON_LABEL = _('Checkout with PayPal')
    CONFIGURATION_MODEL = 'ecommerce.payment_processors.paypal.models.PaypalConfiguration'
    DEFAULT_PROFILE_NAME = 'default'
    NAME = 'paypal'
    URLS_MODULE = 'ecommerce.payment_processors.paypal.urls'
    ...
    @property
    def error_url(self):
        return get_lms_url(settings.ERROR_PAGE_PATH)
    ...
    def handle_processor_response(self, response, basket=None):
        ...
        if waffle.switch_is_active('PAYPAL_RETRY_ATTEMPTS'):
            available_attempts = available_attempts + self.configuration.retry_attempts
