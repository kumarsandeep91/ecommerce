...
from ecommerce.extensions.payment.exceptions import InvalidSignatureError, PartialAuthorizationError
from ecommerce.extensions.payment.helpers import sign
from ecommerce.extensions.payment.processors import BasePaymentProcessor
from ecommerce.extensions.payment.transport import RequestsTransport
from ecommerce.payment_processors.cybersource.exceptions import InvalidCybersourceDecision
...
class Cybersource(BasePaymentProcessor):
    ...
    CONFIGURATION_MODEL = 'ecommerce.payment_processors.cybersource.models.CybersourceConfiguration'
    NAME = 'cybersource'
    URLS_MODULE = 'ecommerce.payment_processors.cybersource.urls'
    ...
    def get_transaction_parameters(self, basket, request=None):
        ...
        # Level 2/3 details
        if self.configuration.send_level_2_3_details:
        ...
        parameters['payment_page_url'] = self.configuration.payment_page_url
    ...
    def _generate_signature(self, parameters):
        ...
        return sign(message, self.configuration.secret_key)
    ...
    def issue_credit(self, source, amount, currency):
        ...
        try:
            ...
            security = Security()
            token = UsernameToken(self.configuration.merchant_id, self.configuration.transaction_key)
            security.tokens.append(token)

            client = Client(self.configuration.soap_api_url, transport=RequestsTransport())
            ...
            response = client.service.runTransaction(merchantID=self.configuration.merchant_id,
