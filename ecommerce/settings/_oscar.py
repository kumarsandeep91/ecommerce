...
OSCAR_REFUND_STATUS_PIPELINE = {
    REFUND.OPEN: (
        REFUND.PENDING_WITH_REVOCATION, REFUND.PENDING_WITHOUT_REVOCATION,
        REFUND.DENIED, REFUND.PAYMENT_REFUND_ERROR, REFUND.PAYMENT_REFUNDED
    ),
    REFUND.PENDING_WITH_REVOCATION: (REFUND.PAYMENT_REFUNDED, REFUND.PAYMENT_REFUND_ERROR),
    REFUND.PENDING_WITHOUT_REVOCATION: (REFUND.PAYMENT_REFUNDED, REFUND.PAYMENT_REFUND_ERROR),
...
OSCAR_REFUND_LINE_STATUS_PIPELINE = {
    REFUND_LINE.OPEN: (
        REFUND_LINE.PENDING_WITH_REVOCATION, REFUND_LINE.PENDING_WITHOUT_REVOCATION,
        REFUND_LINE.DENIED, REFUND_LINE.REVOCATION_ERROR, REFUND_LINE.COMPLETE
    ),
    REFUND.PENDING_WITH_REVOCATION: (REFUND_LINE.REVOCATION_ERROR, REFUND_LINE.COMPLETE),
    REFUND.PENDING_WITHOUT_REVOCATION: (REFUND_LINE.REVOCATION_ERROR, REFUND_LINE.COMPLETE),
