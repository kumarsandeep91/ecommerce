...
PAYMENT_PROCESSOR_CONFIG = {
    'edx': {
        ...
        'invoice': {},
        'adyen': {
            'web_service_username': 'fake-username',
            'web_service_password': 'fake-password',
            'merchant_account_code': 'fake-merchant-account-code',
            'cse_public_key': 'fake-public-key',
    ...
    'other': {
        ...
        'invoice': {},
        'adyen': {
            'web_service_username': 'other-fake-username',
            'web_service_password': 'other-fake-password',
            'merchant_account_code': 'other-fake-merchant-account-code',
            'cse_public_key': 'other-fake-public-key',
            'payment_api_url': 'https://replace-me/',
            'receipt_path': PAYMENT_PROCESSOR_RECEIPT_PATH,
            'cancel_path': PAYMENT_PROCESSOR_CANCEL_PATH,
        },
